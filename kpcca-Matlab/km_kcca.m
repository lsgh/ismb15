function [y1,y2,beta] = km_kcca(X1,X2,kernel1,kernel2,reg,decomp,lrank, w)
...
% USAGE: [y1,y2,beta] = km_kcca(X1,X2,kernel1,krnel2,reg,decomp,lrank,w)
%
...
switch decomp
	case 'ICD' % incomplete Cholesky decomposition
		...
		G1 = km_kernel_icd(X1,kernel1{1},kernel1{2}, rank(X1) , 10^-6, w);
		G2 = km_kernel_icd(X2,kernel2{1},kernel2{2}, rank(X2) , 10^-6, w);
